...
import pl.mcpm.spring5recipeapp.models.*;
import pl.mcpm.spring5recipeapp.repositories.CategoryRepository;
import pl.mcpm.spring5recipeapp.repositories.RecipeRepository;
import pl.mcpm.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        //unitOfMeasureRepository.saveAll(getUOM());
        log.debug("Loading Bootstrap Data");
    }

    private List<UnitOfMeasure> getUOM() {
        List<UnitOfMeasure> uoms = new ArrayList<>(2);
        uoms.add(new UnitOfMeasure("Dupa"));
        uoms.add(new UnitOfMeasure("Romana"));
        return uoms;
    }
